...
> Blink is a statically-typed, effect-tracked language compiling to C. **Compiler v0.44.0**.
...
Tags: `latest`, `0.44`, `0.44.0` (semver). Image is `debian:bookworm-slim` with `gcc`, `zig`, `blink`, `libgc-dev`, and `libsqlite3-dev`.
